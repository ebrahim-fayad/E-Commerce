...
@section('title') Seller-login-page @endsection
@section('head-title') Seller Login @endsection
@section('content')
    <form accept="{{ route('seller.login') }}" method="POST">
        @csrf
        ...
        <div class="row pb-30">
            ...
            <div class="col-6">
                <div class="forgot-password">
                    <a href="{{ route('seller.forget-seller-password') }}">Forgot Password</a>
                </div>
            </div>
        </div>
        <div class="row">
