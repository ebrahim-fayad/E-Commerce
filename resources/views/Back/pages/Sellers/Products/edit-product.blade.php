@extends('Back.layouts.pages-layouts.back-master',['title_page' => 'Seller Edite Product'])
@section('title')Seller Edite Product @endsection
{{-- @section('home-active')active @endsection --}}
@section('content')
<form action="{{ route('seller.product.update-product',$product->id) }}" method="POST" enctype="multipart/form-data" id="addProductForm">
    @method('PUT')
    @csrf
    <div class="row pd-10">
        <div class="col-md-8 mb-20">
            <div class="card-box height-100-p pd-20" style="position: relative">
                ...
                <div class="form-group">
                    ...
                    <textarea id="summary" name="summary" class="form-control summernote" cols="30" rows="10">{{ $product->summary }}</textarea>
                ...
                <div class="d-block mb-3" style="max-width: 250px;">
                  <img src="{{ $product->product_image }}" class="img-thumbnail" id="image-preview" data-ijabo-default-img="">
                </div>
            ...
            <div class="card-box min-height-120px pd-20">
               <div class="form-group">
                 ...
                 <select name="visibility" id="" class="form-control">
                    ...
                    <option value="0"{{$product->visibility == 0 ? 'selected' : '' }}{{$product->visibility == 1 ? 'selected' : '' }}>Private</option>
                 </select>
               </div>
            </div>
        </div>
